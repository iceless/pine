...
#define FS2_OAUTH_KEY    (@"1GEGKFROQZP33MLJWVT2LOSSCCUI3NETVDD3KMTQEZFHLVAR")
#endif

#ifndef FS2_OAUTH_SECRET
#define FS2_OAUTH_SECRET (@"YPAI4IGDOPWHW0VOD4CPRO3X2KI2GWO1V1UBAEOWTQAIPCG4")
#endif

//2, don't forget to added app url in your info plist file CFBundleURLTypes
#ifndef FS2_REDIRECT_URL
#define FS2_REDIRECT_URL @"app://pine"
#endif

//3 update this date to use up-to-date Foursquare API
#ifndef FS2_API_VERSION
#define FS2_API_VERSION (@"20130605")
#endif
